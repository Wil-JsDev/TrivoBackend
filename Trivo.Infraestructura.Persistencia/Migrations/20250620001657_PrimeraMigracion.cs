    ...
    public partial class PrimeraMigracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKAdministradorId", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKHabilidadId", x => x.HabilidadId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKUsuarioId", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKCodigoId", x => x.CodigoId);
                    table.ForeignKey(
                        name: "FKUsuariosId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKExpertoId", x => x.Id);
                    table.ForeignKey(
                        name: "FKUsuariosId",
                        column: x => x.FkUsuariosId,
                        principalTable: "Usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKNotificacionId", x => x.NotificacionId);
                    table.ForeignKey(
                        name: "FKUsuariosId",
                        column: x => x.FkUsuariosId,
                        principalTable: "Usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKReclutadorId", x => x.Id);
                    table.ForeignKey(
                        name: "FKUsuariosId",
                        column: x => x.FkUsuariosId,
                        principalTable: "Usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKEmparejamientoId", x => x.Id);
                    table.ForeignKey(
                        name: "FKExpertoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKCategoriaInteresId", x => x.CategoriaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKInteresId", x => x.Id);
                    table.ForeignKey(
                        name: "FKCategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PkChatId", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkChatId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PKReporteId", x => x.ReporteId);
                    table.ForeignKey(
                        name: "FKMensajeId",
