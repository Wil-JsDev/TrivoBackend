...
public interface INotificadorDeNotificaciones
{
    ...
    Task NotificarNotificacionMarcadaComoLeida(Guid usuarioId, Guid notificacionId, NotificacionDto notificacion);
    
    Task NotificarNotificacionEliminada(Guid usuarioId,Guid notificacionId, NotificacionDto notificacion);
}